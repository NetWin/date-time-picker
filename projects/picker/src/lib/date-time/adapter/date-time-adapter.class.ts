 ...
 */
export const OWL_DATE_TIME_LOCALE_PROVIDER: Provider = {
...
export abstract class DateTimeAdapter<T> {
  ...
  public readonly localeChanges$ = this._localeChanges.asObservable();
   ...
   */
  public abstract parse(value: Nullable<string | number>): Nullable<T>;
   ...
   */
  public deserialize(value: Nullable<T>): Nullable<T> {
   ...
   */
  public clampDate(date: T, min?: Nullable<T>, max?: Nullable<T>): T {
