...
export type DateTimePickerAnimations = Readonly<{
  transformPicker: AnimationTriggerMetadata;
  fadeInPicker: AnimationTriggerMetadata;
}>;

const transformPicker = trigger('transformPicker', [
