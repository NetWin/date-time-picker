...
import { OwlDateTimeInputDirective } from '../date-time-input/date-time-input.directive';
  ...
  describe('with OwlNativeDateTimeModule', () => {
    describe('standard DateTimePicker', () => {
      ...
      it('should initialize with correct value shown in input', () => {
        if (SUPPORTS_INTL) {
          ...
          expect(input.value).toBe('1/1/2020, 12:00 AM');
        }
      });
      ...
      it('should open dialog when pickerMode is "dialog"', () => {
        ...
        let dialogContainer = document.querySelector('.owl-dt-dialog owl-dialog-container');
        expect(dialogContainer).toBeNull();

        testComponent.dateTimePicker.open();
        fixture.detectChanges();

        dialogContainer = document.querySelector('.owl-dt-dialog owl-dialog-container');
      ...
      it('should close popup panel when cancel button clicked', fakeAsync(() => {
        ...
        const componentPredicate = By.directive(OwlDateTimeContainerComponent);
        const containerDebugElement = fixture.debugElement.query(componentPredicate);
        containerElement = containerDebugElement.nativeElement;

        const btns = containerElement.querySelectorAll('.owl-dt-container-control-button');
      ...
      it('should close popup panel and not update input value when cancel button clicked', fakeAsync(() => {
        ...
        const monthCell = containerElement.querySelector<HTMLElement>('[aria-label="January 2, 2020"]')!;
        monthCell.click();
        fixture.detectChanges();
        ...
        expect(testComponent.dateTimePickerInput.value).toEqual(new Date(2020, MONTHS.JAN, 1));
      }));
      ...
      it('should update input value to pickerMoment value and close popup panel when set button clicked', fakeAsync(() => {
        ...
        const containerDebugElement = fixture.debugElement.query(componentPredicate);
        containerElement = containerDebugElement.nativeElement;
        expect(containerDebugElement.componentInstance.pickerMoment).toEqual(new Date(2020, MONTHS.JAN, 1));
      ...
      it('should update input value to clicked date value and close popup panel when set button clicked', fakeAsync(() => {
        ...
        expect(testComponent.dateTimePicker.opened)
          .withContext('Expected dateTimePicker to be closed.')
          .toBe(false);
        expect(testComponent.dateTimePickerInput.value).toEqual(new Date(2020, MONTHS.JAN, 2));
      }));

      it('should set startAt fallback to input value', () => {
        expect(testComponent.dateTimePicker.startAt).toEqual(new Date(2020, MONTHS.JAN, 1));
      });
      ...
      describe('with only calendar', () => {
        ...
        it('should initialize with correct value shown in input', () => {
          if (SUPPORTS_INTL) {
            const input = fixture.nativeElement.querySelector('input');
            expect(input.value).toBe('1/1/2020');
          }
        });
        ...
        it('should update input value to clicked date value and close popup panel when date cell is clicked', fakeAsync(() => {
          ...
          flush();
          expect(testComponent.dateTimePicker.opened)
            .withContext('Expected dateTimePicker to be opened.').toBe(true);

          const containerDebugElement = fixture.debugElement.query(By.directive(OwlDateTimeContainerComponent));
          containerElement = containerDebugElement.nativeElement;
          expect(containerDebugElement.componentInstance.pickerMoment).toEqual(new Date(2020, MONTHS.JAN, 1));
          ...
          expect(testComponent.dateTimePicker.opened)
            .withContext('Expected dateTimePicker to be closed.').toBe(false);
          expect(testComponent.dateTimePickerInput.value).toEqual(new Date(2020, MONTHS.JAN, 2));
        }));
        ...
        it('should close popup panel when click on the selected date', fakeAsync(() => {
          ...
          containerElement = containerDebugElement.nativeElement;
          expect(containerDebugElement.componentInstance.pickerMoment).toEqual(new Date(2020, MONTHS.JAN, 1));
          expect(testComponent.dateTimePicker.selected).toEqual(new Date(2020, MONTHS.JAN, 1));
    ...
    describe('range DateTimePicker', () => {
      ...
      it('should initialize with correct value shown in input', () => {
        if (SUPPORTS_INTL) {
          const input = fixture.nativeElement.querySelector('input');
          expect(input.value).toBe('1/1/2020, 12:00 AM - 2/1/2020, 12:00 AM');
        }
      });
      ...
      it('clicking the dateCell should set the rangeFrom value when both rangeFrom and rangeTo had NO value', fakeAsync(() => {
        ...
        expect(testComponent.dateTimePicker.selecteds[0]).toEqual(new Date(2020, MONTHS.JAN, 2));
      ...
      it('clicking the dateCell should set the rangeFrom value when dateCell value is before the old rangeFrom value',
        fakeAsync(() => {
          testComponent.dates = [new Date(2020, MONTHS.JAN, 2), null];
          fixture.detectChanges();
          ...
          expect(containerDebugElement.componentInstance.activeSelectedIndex).toBe(0);
          expect(testComponent.dateTimePicker.selecteds.length).toBe(2);
          expect(testComponent.dateTimePicker.selecteds[0]).toEqual(new Date(2020, MONTHS.JAN, 1));
          expect(testComponent.dateTimePicker.selecteds[1]).toBe(null);
        }));
      ...
      it('clicking the dateCell should set the rangeTo value when rangeFrom already had value', fakeAsync(() => {
        ...
        expect(testComponent.dateTimePicker.selecteds.length).toBe(2);
        expect(testComponent.dateTimePicker.selecteds[0]).toEqual(new Date(2020, MONTHS.JAN, 2));
        expect(testComponent.dateTimePicker.selecteds[1]).toEqual(new Date(2020, MONTHS.JAN, 3));
      }));
      ...
      it('if endAt value is set, the end time value should be shown in the rangeTo calendar end time', fakeAsync(() => {
        ...
        const containerDebugElement = fixture.debugElement.query(componentPredicate);
        containerElement = containerDebugElement.nativeElement;
        const dateCell = containerElement.querySelector('[aria-label="January 20, 2020"]')!;
        dispatchMouseEvent(dateCell, 'click');
        fixture.detectChanges();
        flush();
      ...
      describe('with only calendar', () => {
        ...
        it('should initialize with correct value shown in input', () => {
          if (SUPPORTS_INTL) {
            const input = fixture.nativeElement.querySelector('input');
            expect(input.value).toBe('1/1/2020 - 2/1/2020');
          }
        });
    ...
    describe('DateTimePicker with too many inputs', () => {
      it('should throw when multiple inputs registered', fakeAsync(() => {
        const fixture = createComponent(
          MultiInputDateTimePickerComponent,
          [OwlNativeDateTimeModule]
        );
    ...
    describe('DateTimePicker with no input', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(
          NoInputDateTimePickerComponent,
          [OwlNativeDateTimeModule]
        );
        fixture.detectChanges();
      ...
      it('should NOT throw when accessing disabled property', () => {
        const fn = (): boolean => testComponent.dateTimePicker.disabled;
    ...
    describe('DateTimePicker with startAt', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(
          DateTimePickerWithStartAtComponent,
          [OwlNativeDateTimeModule]
        );
        fixture.detectChanges();
      ...
      it('should override input value by explicit startAt', () => {
        expect(testComponent.dateTimePicker.startAt).toEqual(new Date(2010, MONTHS.JAN, 1));
      });
    });
    ...
    describe('DateTimePicker with startView', () => {
      ...
      beforeEach(() => {
        fixture = createComponent(
          DateTimePickerWithStartViewComponent,
          [OwlNativeDateTimeModule]
        );
        fixture.detectChanges();
      ...
      describe('set to year', () => {
        ...
        it('should start at the year view', () => {
          ...
          const componentPredicate = By.directive(OwlDateTimeContainerComponent);
          containerDebugElement = fixture.debugElement.query(componentPredicate);
          containerElement = containerDebugElement.nativeElement;
          const yearTable = containerElement.querySelector('table.owl-dt-calendar-year-table');
      ...
      describe('set to multi-years', () => {
        ...
        it('should start at the multi-years view', () => {
          ...
          containerDebugElement = fixture.debugElement.query(componentPredicate);
          containerElement = containerDebugElement.nativeElement;
          const multiYearTable = containerElement.querySelector('table.owl-dt-calendar-multi-year-table');
    ...
    describe('DateTimePicker with NgModel', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(
          DateTimePickerWithNgModelComponent,
          [OwlNativeDateTimeModule]
        );
        fixture.detectChanges();
      ...
      it('should update dateTimePicker when model changes', fakeAsync(() => {
        ...
        const selected = new Date(2017, MONTHS.JAN, 1);
      ...
      it('should mark input dirty after date selected', fakeAsync(() => {
        ...
        testComponent.dateTimePicker.select(new Date(2017, MONTHS.JAN, 1));
        fixture.detectChanges();
        flush();
        testComponent.dateTimePicker.confirmSelect();
        fixture.detectChanges();
      ...
      it('should not mark dirty after model change', fakeAsync(() => {
        ...
        testComponent.moment = new Date(2017, MONTHS.JAN, 1);
        fixture.detectChanges();
        flush();
        fixture.detectChanges();
      ...
      describe('with range mode', () => {
        ...
        it('should update dateTimePicker when model changes', fakeAsync(() => {
          ...
          const from = new Date(2017, MONTHS.JAN, 1);
          const to = new Date(2017, MONTHS.JAN, 3);
        ...
        it('should update model when date is selected', fakeAsync(() => {
          ...
          expect(testComponent.moment instanceof Array).toBe(true);
          expect((testComponent.moment as Array<Date>)[0]).toEqual(from);
          expect((testComponent.moment as Array<Date>)[1]).toEqual(to);
          expect(testComponent.dateTimePickerInput.values.length).toBe(2);
          expect(testComponent.dateTimePickerInput.values[0]).toEqual(from);
          expect(testComponent.dateTimePickerInput.values[1]).toEqual(to);
        }));
      ...
      describe('with rangeFrom mode', () => {
        ...
        it('should only update fromValue when date is selected', fakeAsync(() => {
          ...
          const newSelectedFrom = new Date(2017, MONTHS.JAN, 2);
          const componentPredicate = By.directive(OwlDateTimeContainerComponent);
          const containerDebugElement = fixture.debugElement.query(componentPredicate);
        ...
        it('should update fromValue and set toValue to null when date is selected after toValue', fakeAsync(() => {
          ...
          const newSelectedFrom = new Date(2017, MONTHS.JAN, 4);
          const componentPredicate = By.directive(OwlDateTimeContainerComponent);
          const containerDebugElement = fixture.debugElement.query(componentPredicate);
          containerDebugElement.componentInstance.dateSelected(newSelectedFrom);
          fixture.detectChanges();
      ...
      describe('with rangeTo mode', () => {
        ...
        it('should only update toValue when date is selected', fakeAsync(() => {
          ...
          const newSelectedTo = new Date(2017, MONTHS.JAN, 4);
          const componentPredicate = By.directive(OwlDateTimeContainerComponent);
          const containerDebugElement = fixture.debugElement.query(componentPredicate);
        ...
        it('should update toValue and set fromValue to null when date is selected before fromValue', fakeAsync(() => {
          const from = new Date(2017, MONTHS.JAN, 2);
          const to = new Date(2017, MONTHS.JAN, 3);
          testComponent.moment = [from, to];
          fixture.detectChanges();
          flush();
          ...
          const newSelectedTo = new Date(2017, MONTHS.JAN, 1);
          const componentPredicate = By.directive(OwlDateTimeContainerComponent);
          const containerDebugElement = fixture.debugElement.query(componentPredicate);
          containerDebugElement.componentInstance.dateSelected(newSelectedTo);
          fixture.detectChanges();
    ...
    describe('DateTimePicker with FormControl', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(
          DateTimePickerWithFormControlComponent,
          [OwlNativeDateTimeModule]
        );
        fixture.detectChanges();
    ...
    describe('DateTimePicker with owlDateTimeTrigger', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(
          DateTimePickerWithTriggerComponent,
          [OwlNativeDateTimeModule]
        );
        fixture.detectChanges();
        testComponent = fixture.componentInstance;
    ...
    describe('DateTimePicker with min and max validation', () => {
      ...
      beforeEach(fakeAsync(() => {
        ...
        minMoment = new Date(2010, MONTHS.JAN, 1, 0, 30, 30);
        maxMoment = new Date(2020, MONTHS.JAN, 1, 23, 30, 30);
      ...
      it('should use min and max dates specified by the input', () => {
        const minDateTime = testComponent.dateTimePicker.minDateTime;
        expect(minDateTime).toEqual(minMoment!);

        const maxDateTime = testComponent.dateTimePicker.maxDateTime;
        expect(maxDateTime).toEqual(maxMoment!);
      });

      it('should mark invalid when value is before minMoment', fakeAsync(() => {
        testComponent.date = new Date(2009, MONTHS.DEC, 31);
        fixture.detectChanges();
        flush();
        fixture.detectChanges();
      ...
      it('should mark invalid when value is after maxMoment', fakeAsync(() => {
        testComponent.date = new Date(2020, MONTHS.JAN, 2);
        fixture.detectChanges();
        flush();
      ...
      it('should not mark invalid when value equals minMoment', fakeAsync(() => {
        ...
        const inputElement = fixture.debugElement.query(By.css('input')).nativeElement;
        expect(inputElement.classList).not.toContain('ng-invalid');
      }));
      ...
      it('should not mark invalid when value is between minMoment and maxMoment', fakeAsync(() => {
        testComponent.date = new Date(2010, MONTHS.JAN, 2);
        fixture.detectChanges();
        flush();
        fixture.detectChanges();
      ...
      it('should disable all decrease-time buttons when value equals minMoment', fakeAsync(() => {
        ...
        flush();
        fixture.detectChanges();
        const calendarDebugElement = fixture.debugElement.query(By.directive(OwlDateTimeContainerComponent));
    ...
    describe('DateTimePicker with filter validation', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(
          DateTimePickerWithFilterValidationComponent,
          [OwlNativeDateTimeModule]
        );
        fixture.detectChanges();
        testComponent = fixture.componentInstance;
      ...
      it('should mark input invalid', fakeAsync(() => {
        testComponent.date = new Date(2017, MONTHS.JAN, 1);
        fixture.detectChanges();
        flush();
        fixture.detectChanges();

        const inputElementbefore = fixture.debugElement.query(By.css('input')).nativeElement;
        expect(inputElementbefore.classList).toContain('ng-invalid');

        testComponent.date = new Date(2017, MONTHS.JAN, 2);
        fixture.detectChanges();
        flush();
        fixture.detectChanges();

        const inputElementAfter = fixture.debugElement.query(By.css('input')).nativeElement;
        expect(inputElementAfter.classList).not.toContain('ng-invalid');
      }));

      it('should disable filtered calendar cells', fakeAsync(() => {
        testComponent.date = new Date(2017, MONTHS.JAN, 3);
        fixture.detectChanges();
        flush();
        fixture.detectChanges();
    ...
    describe('DateTimePicker with ISO strings', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(
          DateTimePickerWithISOStringsComponent,
          [OwlNativeDateTimeModule]
        );
        fixture.detectChanges();
        testComponent = fixture.componentInstance;
      ...
      it('should coerce ISO strings', fakeAsync(() => {
        ...
        expect(testComponent.dateTimePicker.startAt).toEqual(new Date(2017, MONTHS.JUL, 1));
        expect(testComponent.dateTimePickerInput.value).toEqual(new Date(2017, MONTHS.JUN, 1));
        expect(testComponent.dateTimePickerInput.min).toEqual(new Date(2017, MONTHS.JAN, 1));
        expect(testComponent.dateTimePickerInput.max).toEqual(new Date(2017, MONTHS.DEC, 31));
      }));
    });
    ...
    describe('DateTimePicker with events', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(
          DateTimePickerWithEventsComponent,
          [OwlNativeDateTimeModule]
        );
        fixture.detectChanges();
        testComponent = fixture.componentInstance;
...
@Component({
  ...
  `,
  imports: [OwlDateTimeComponent, OwlDateTimeInputDirective]
})
class StandardDateTimePickerComponent {
  public date: Date | null = new Date(2020, MONTHS.JAN, 1);
...
class RangeDateTimePickerComponent {
  public dates: Array<Date | null> | null = [new Date(2020, MONTHS.JAN, 1), new Date(2020, MONTHS.FEB, 1)];
  public selectMode = 'range';
  public pickerType = 'both';
  public startAt = new Date(2020, MONTHS.JAN, 1);
  public endAt = new Date(2020, MONTHS.JAN, 2);
  @ViewChild('dt', { static: true })
  public dateTimePicker!: OwlDateTimeComponent<Date>;
  @ViewChild(OwlDateTimeInputDirective, { static: true })
  public dateTimePickerInput!: OwlDateTimeInputDirective<Date>;
...
class DateTimePickerWithStartAtComponent {
  public date = new Date(2020, MONTHS.JAN, 1);
  public startDate = new Date(2010, MONTHS.JAN, 1);
  @ViewChild('dt', { static: true })
  public dateTimePicker!: OwlDateTimeComponent<Date>;
}
...
@Component({
  ...
  template: `
    ...
    <owl-date-time #dt />
  `,
  imports: [FormsModule, OwlDateTimeComponent, OwlDateTimeInputDirective]
})
class DateTimePickerWithNgModelComponent {
  public moment: Array<Date | null> | Date | null = null;
...
@Component({
  ...
  template: `
    ...
    <owl-date-time #dt />
  `,
  imports: [ReactiveFormsModule, OwlDateTimeComponent, OwlDateTimeInputDirective, OwlDateTimeTriggerDirective]
})
...
@Component({
  ...
  template: `
    ...
    <owl-date-time #dt></owl-date-time>
  `,
  imports: [OwlDateTimeComponent, OwlDateTimeTriggerDirective, OwlDateTimeInputDirective]
})
...
@Component({
  ...
  `,
  imports: [FormsModule, OwlDateTimeComponent, OwlDateTimeInputDirective, OwlDateTimeTriggerDirective]
})
...
class DateTimePickerWithFilterValidationComponent {
  ...
  public filter: DateFilter<Date> = (date: Date) => date.getDate() !== 1;
}
...
@Component({
  ...
  template: `
    ...
    <owl-date-time #dt [showSecondsTimer]="true"></owl-date-time>
  `,
  imports: [OwlDateTimeComponent, OwlDateTimeInputDirective, OwlDateTimeTriggerDirective]
})
class DateTimePickerWithChangeAndInputEventsComponent {
  ...
  public handleChange(): void { /** noop */ }
  public handleInput(): void { /** noop */ }
  public handleDateTimeChange(): void {/** noop */ }
  public handleDateTimeInput(): void { /** noop */ }
}
...
class DateTimePickerWithISOStringsComponent {
  public value = new Date(2017, MONTHS.JUN, 1).toISOString();
  public min = new Date(2017, MONTHS.JAN, 1).toISOString();
  public max = new Date(2017, MONTHS.DEC, 31).toISOString();
  public startAt = new Date(2017, MONTHS.JUL, 1).toISOString();
  @ViewChild('dt', { static: true })
  public dateTimePicker!: OwlDateTimeComponent<Date>;
  @ViewChild(OwlDateTimeInputDirective, { static: true })
  public dateTimePickerInput!: OwlDateTimeInputDirective<Date>;
...
@Component({
  standalone: true,
  template: `
    <input [owlDateTime]="dt" [(ngModel)]="selected">
    <owl-date-time
      #dt
